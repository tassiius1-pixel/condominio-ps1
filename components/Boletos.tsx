...
export const Boletos: React.FC<BoletosProps> = ({ setView }) => {
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-20">
      ...
      {/* ======================================================= */}
      {isUploadModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-start sm:items-center justify-center bg-black/60 backdrop-blur-sm p-4 pt-12 sm:pt-4 overflow-y-auto">
          <div className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border border-gray-250 dark:border-gray-800 w-full max-w-2xl rounded-[2rem] shadow-2xl flex flex-col my-4 animate-fade-in overflow-hidden border-white/50">
            ...
            <div className="flex-1 p-6 overflow-y-auto max-h-[calc(100dvh-150px)] sm:max-h-[75vh] bg-transparent">
                    ...
                    <div className="space-y-4">
                      <div className="grid gap-2">
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 border-2 border-gray-200 hover:border-gray-300 dark:border-gray-750 bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 transition-all font-semibold text-base"
                        />
                      </div>
